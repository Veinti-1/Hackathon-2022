...
do
{
    ...
    while (!Regex.IsMatch(problema, @"[0-4]"))
    {
...
void Problema1()
{
    ...
    while (!Regex.IsMatch(sumastr, @"[1-2]"))
    {
        Console.WriteLine("Por favor ingrese un valor valido");
        sumastr = Console.ReadLine();
    }
    ...
    while (!Regex.IsMatch(baseNum, @"[1-3]"))
    {
        Console.WriteLine("Por favor ingrese un valor valido");
        baseNum = Console.ReadLine();
    }
...
void Problema3()
{
    ...
    string inputFact = Console.ReadLine();
    while (!Regex.IsMatch(inputFact, @"[0-9]+!"))
    {
        Console.WriteLine("Por favor ingrese un valor valido");
        inputFact = Console.ReadLine();
    }
    int x = Convert.ToInt32(inputFact.Substring(0, inputFact.Length-1));
    int resultado = 1;
    while (x > 0)
    {
        resultado *= x;
...
void Problema4()
{
    ...
    string numAmigosstr = Console.ReadLine();
    while (!Regex.IsMatch(numAmigosstr, @"[d+]"))
    {
        Console.WriteLine("Por favor ingrese un valor valido");
        numAmigosstr = Console.ReadLine();
    }
    int numAmigos = Convert.ToInt32(numAmigosstr);
    Console.WriteLine("Ingrese numero de porciones por amigo");
    string numPorcionesstr = Console.ReadLine();
    while (!Regex.IsMatch(numPorcionesstr, @"[d+]"))
    {
        Console.WriteLine("Por favor ingrese un valor valido");
        numPorcionesstr = Console.ReadLine();
    }
    int numPorciones = Convert.ToInt32(numPorcionesstr);
